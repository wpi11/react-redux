This is a React Redux project created with [Create React App](https://github.com/facebook/create-react-app). It includes TypeScript and Redux Toolkit for state management.
